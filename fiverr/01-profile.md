# Fiverr profile — Bilal Sagheer

Fiverr is not Upwork with a different logo. On Upwork you go to clients; on
Fiverr clients come to you through **search**. Your titles are SEO, your gig
images matter more than your text, and your first job is getting any order at all
so the algorithm has data on you.
...
It's the last profile-strength point and worth doing. Make it a development
video — script in `00-convert-existing-profile.md`.
...
## The three things that decide whether you sell
...
## Fiverr vs Upwork — run both, differently

| | Upwork | Fiverr |
|---|---|---|
| How work arrives | You send proposals | Buyers find your gigs |
| Cost | Connects per proposal | Free to list |
| Platform fee | 10% | **20%** |
