...
| 2 | **Next.js + Supabase web app** — auth, database, server actions | Consulting site, booking app | $500–2,000 | 2–4 weeks |
| 3 | **Marketing site / landing page** — fast, responsive, animated | 45-page commerce site, roaster site | $250–800 | 4–10 days |
| 4 | **Figma / design → pixel-accurate Next.js build** | 45-page commerce site | $200–1,200 | 3 days–3 weeks |
...
| 9 | **AI feature integration** — chat, assistants, AI-assisted forms | Consulting site (Vercel AI SDK) | $300–1,000 | 1–2 weeks |
...
| 13 | **Software licensing for a desktop app** — signed offline licences, activation windows, remote revocation | Offline desktop products | $500–1,500 | 1–3 weeks |
| 14 | **E-commerce storefront** — catalog, cart, checkout, orders | Storefront and ordering apps | $600–2,500 | 2–5 weeks |
...
- Any job whose portfolio questions you can't answer in detail on a call.
