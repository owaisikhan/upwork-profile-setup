...
business that's in daily production use — daily entries, stock, customer credit
...
in a Next.js + Supabase app, both traced and fixed through a reviewed PR.
...
- Get on a call if they offer. Your English is fine, and a call converts far
  better than chat.
